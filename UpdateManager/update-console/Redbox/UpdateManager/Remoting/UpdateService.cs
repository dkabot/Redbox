    ...
    internal class UpdateService : IUpdateService
    {
          ...
          string name)
        {
            ...
            using (Redbox.UpdateService.Client.UpdateService service = this.GetService())
            {
                ...
                if (!group1.Success)
                    repository.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)Redbox.UpdateManager.Remoting.UpdateService.IPC((IEnumerable<Redbox.IPC.Framework.Error>)group1.Errors));
                return repository;
            }
        }
          ...
          string name)
        {
            ...
            using (Redbox.UpdateService.Client.UpdateService service = this.GetService())
            {
                ...
                if (!group1.Success)
                    errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)Redbox.UpdateManager.Remoting.UpdateService.IPC((IEnumerable<Redbox.IPC.Framework.Error>)group1.Errors));
                return errorList;
            }
        }
          ...
          string name)
        {
            ...
            using (Redbox.UpdateService.Client.UpdateService service = this.GetService())
            {
                ...
                if (!store.Success)
                    repository.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)Redbox.UpdateManager.Remoting.UpdateService.IPC((IEnumerable<Redbox.IPC.Framework.Error>)store.Errors));
                return repository;
            }
        }
          ...
          string name)
        {
            ...
            using (Redbox.UpdateService.Client.UpdateService service = this.GetService())
            {
                ...
                if (!store.Success)
                    errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)Redbox.UpdateManager.Remoting.UpdateService.IPC((IEnumerable<Redbox.IPC.Framework.Error>)store.Errors));
                return errorList;
            }
        }
                ...
                foreach (ChangeSet changeSet in changeSets)
                {
                    if (!inTransit.Contains(changeSet.Name) && service3.Subscribed(changeSet.Name))
                    {
                        ...
                        try
                        {
                            ...
                            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)service1.CreateDownloadJob(name, out job));
                            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job.SetMinimumRetryDelay((uint)this.m_minimumRetryDelay));
                            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job.SetNoProgressTimeout(storeScheduleInfo.NoProgressTimeout));
                            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job.AddItem(changeSet.Url, Path.GetTempFileName()));
        ...
        public Redbox.UpdateManager.ComponentModel.ErrorList StartDownloads()
        {
            ...
            try
            {
                ...
                using (Redbox.UpdateService.Client.UpdateService service4 = this.GetService())
                {
                    ...
                    {
                        errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)Redbox.UpdateManager.Remoting.UpdateService.IPC((IEnumerable<Redbox.IPC.Framework.Error>)changeSet.Errors));
                        return errorList;
                    }
                }
                ...
                foreach (ChangeSet o in jobs)
                {
                    if (!inTransit.Contains(o.Name) && service3.Subscribed(o.Name))
                    {
                        ...
                        try
                        {
                            ...
                            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)service1.CreateDownloadJob(name, out job));
                            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job.SetMinimumRetryDelay((uint)this.m_minimumRetryDelay));
                            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job.SetNoProgressTimeout(store.NoProgressTimeout));
                            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job.AddItem(o.Url, Path.GetTempFileName()));
                            if (errorList.ContainsError())
                            {
                                errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job.Cancel());
                            }
        ...
        public Redbox.UpdateManager.ComponentModel.ErrorList FinishDownloads()
        {
            ...
            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)service1.GetJobs(out jobs, false));
            if (errorList.ContainsError())
                return errorList;
                ...
                if (transferJob.Name.StartsWith("<~") && transferJob.Name.EndsWith("~>"))
                {
                    switch (transferJob.Status)
                    {
                        ...
                        case TransferStatus.Transferred:
                            errorList.AddRange(transferJob.JobType == TransferJobType.Download ? (IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)this.FinishDownload(transferJob.ID) : (IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)this.FinishUpload(transferJob.ID));
                            continue;
                        default:
        ...
        public Redbox.UpdateManager.ComponentModel.ErrorList FinishUpload(Guid jobId)
        {
            ...
            try
            {
                ...
                if (upload == null)
                {
                    ...
                    ITransferJob job;
                    errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)service1.GetJob(jobId, out job));
                    if (job != null && !errorList.ContainsError())
                        errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job.Cancel());
                    return errorList;
                }
                ITransferJob job1;
                errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)service1.GetJob(jobId, out job1));
                if (errorList.ContainsError())
                    return errorList;
                UploadReport entry;
                if (job1.Status == TransferStatus.Error)
                {
                    ...
                    errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job1.Cancel());
                }
                else
                {
                    ...
                    entry = uploadReport;
                    errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job1.Complete());
                }
        ...
        public Redbox.UpdateManager.ComponentModel.ErrorList FinishDownload(Guid jobId)
        {
            ...
            try
            {
                ...
                if (changeSet == null)
                {
                    errorList.Add(Redbox.UpdateManager.ComponentModel.Error.NewError("M001", string.Format("Job file for job: {0}", (object)jobId), "Job file is missing the bits jobs will be canceled."));
                    ITransferJob job2;
                    errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)service1.GetJob(jobId, out job2));
                    if (job2 != null)
                        errorList.AddRange(job2.Status == TransferStatus.Transferred ? (IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job2.Complete() : (IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job2.Cancel());
                    return errorList;
                }
                errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)service1.GetJob(jobId, out job1));
                if (errorList.ContainsError())
                ...
                errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)job1.GetItems(out items));
                if (errorList.ContainsError())
                    return errorList;
                if (items.Count != 1)
                {
        ...
        {
            Redbox.UpdateManager.ComponentModel.ErrorList errorList = new Redbox.UpdateManager.ComponentModel.ErrorList();
            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)this.FinishDownloads());
            errorList.AddRange((IEnumerable<Redbox.UpdateManager.ComponentModel.Error>)this.StartDownloads());
            return errorList;
        }
