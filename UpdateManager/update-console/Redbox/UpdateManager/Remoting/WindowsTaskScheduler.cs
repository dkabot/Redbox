            ...
            try
            {
                using (ScheduledTasks scheduledTasks = new ScheduledTasks())
                {
                    ...
                    try
                    {
                        ...
                        if (task == null)
                            return;
                        task.IdleWaitMinutes = (idleWaitMinutes ?? 1);
                        ...
                        task.Triggers.Add((Trigger)onIdleTrigger2);
                        task.Save();
                    }
                    finally
                    {
            ...
            try
            {
                using (ScheduledTasks scheduledTasks = new ScheduledTasks())
                {
                    ...
                    try
                    {
                        ...
                        task.Triggers.Add((Trigger)dailyTrigger2);
                        task.Save();
                    }
                    finally
                    {
            ...
            try
            {
                using (ScheduledTasks scheduledTasks = new ScheduledTasks())
                {
                    ...
                    try
                    {
                        ...
                        task.Triggers.Add((Trigger)systemStartTrigger2);
                        task.Save();
                    }
                    finally
                    {
