...
namespace Redbox.UpdateManager.Kernel
{
    internal static class TaskSchedulerFunctions
    {
        ...
        internal static LuaTable EraseNoDefault()
        {
            ...
            {
                LogHelper.Instance.LogException("TaskSchedulerFunctions.EraseNoDefault - unhandled exception", ex);
                return TaskSchedulerFunctions.CreateResultTable(new ErrorList());
            }
        }
