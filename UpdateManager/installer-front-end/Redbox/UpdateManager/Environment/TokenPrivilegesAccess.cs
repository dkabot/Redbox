...
{
    internal class TokenPrivilegesAccess
    {
        ...
        public static bool EnablePrivilege(string privilege)
        {
            try
            {
                ...
                TokenPrivilegesAccess.OpenProcessToken(TokenPrivilegesAccess.GetCurrentProcess(), 40, ref tokenhandle);
                TokenPrivilegesAccess.LookupPrivilegeValue((string)null, privilege, ref lpLuid);
                ...
                TokenPrivilegesAccess.AdjustTokenPrivileges(tokenhandle, 0, ref Newstate, 1024, 0, 0);
                return true;
            }
            catch
            {
