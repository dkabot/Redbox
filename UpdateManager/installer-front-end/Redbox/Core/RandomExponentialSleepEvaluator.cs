...
namespace Redbox.Core
{
    ...
    {
        public RandomExponentialSleepEvaluator(int minimumDelay) : base(((retryCount, exception) => RandomExponentialSleepEvaluator.SleepMilliseconds(retryCount, minimumDelay)))
        {
        }
