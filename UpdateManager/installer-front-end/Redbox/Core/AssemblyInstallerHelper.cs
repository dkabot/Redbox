...
{
    internal class AssemblyInstallerHelper : MarshalByRefObject
    {
          ...
          List<string> errorList)
        {
            ...
            try
            {
                ...
                return ((AssemblyInstallerHelper)domain.CreateInstanceFromAndUnwrap(location, typeof(AssemblyInstallerHelper).FullName)).Execute(targetPath, args, mode.ToString(), errorList);
            }
            finally
            {
                if (domain != null)
        ...
        internal bool Execute(string targetPath, string[] args, string mode, List<string> errors)
        {
            try
            {
                ...
                using (AssemblyInstaller assemblyInstaller = new AssemblyInstaller(targetPath, args))
                {
                    ...
                    try
                    {
                        ...
                        if (dictionary[(object)"RebootRequired"] != null)
                            return true;
                    }
                    catch (Exception ex)
                    {
