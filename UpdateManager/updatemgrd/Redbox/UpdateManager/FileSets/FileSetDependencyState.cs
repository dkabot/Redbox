...
{
    internal class FileSetDependencyState
    {
          ...
          string maxVersion)
        {
            ...
            {
                LogHelper.Instance.Log("FileSetDependencyState.IsDependencyMet - An unhandled exception occurred", ex, LogEntryType.Error);
            }
            return false;
        }
