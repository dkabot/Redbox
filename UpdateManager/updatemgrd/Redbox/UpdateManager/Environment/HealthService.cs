        ...
        public ErrorList Add(string key, TimeSpan expireTime, Action rescue)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    Dictionary<string, HealthService.HealthItem> healthItemList = this._healthItemList;
                    string key1 = key;
                    HealthService.HealthItem healthItem = new HealthService.HealthItem(key1, expireTime, rescue);
                    healthItemList.Add(key1, healthItem);
