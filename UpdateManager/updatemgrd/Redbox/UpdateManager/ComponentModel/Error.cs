...
namespace Redbox.UpdateManager.ComponentModel
{
    internal class Error
    {
        ...
        public static Error NewError(string code, string description, Exception e)
        {
            ...
            stringBuilder.AppendFormat("\r\n\r\nStack Trace:\r\n----------------------------\r\n{0}\r\n", (object)e.StackTrace);
            LogHelper.Instance.Log(string.Format("{0} - {1}", (object)code, (object)description), e, LogEntryType.Error);
        ...
        {
            LogHelper.Instance.Log(string.Format("{0} - {1} - {2}", (object)code, (object)description, (object)details), LogEntryType.Error);
            return new Error(code, description, details, false);
        }

        public static Error NewError(string code, string description)
        {
            LogHelper.Instance.Log(string.Format("{0} - {1}", (object)code, (object)description), LogEntryType.Error);
            return new Error(code, description, string.Empty, false);
        }
