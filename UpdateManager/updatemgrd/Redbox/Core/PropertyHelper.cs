...
namespace Redbox.Core
{
    internal static class PropertyHelper
    {
        ...
        public static void UpdateObjectFromXml(object instance, XmlNode parentNode)
        {
            ...
            {
                if (parentNode1.Attributes["read-only"] == null || string.Compare(parentNode1.Attributes["read-only"].Value, bool.TrueString, true) != 0)
                {
                    ...
                    if (!(element == (PropertyInfo)null))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                MethodInfo method = instance.GetType().GetMethod(customAttribute.SetMethodName, BindingFlags.Instance | BindingFlags.Public);
            ...
            foreach (PropertyInfo property in instance.GetType().GetProperties(BindingFlags.Instance | BindingFlags.Public))
            {
                ...
                if (customAttribute1 == null || customAttribute1.Browsable)
                {
                    ...
                    if (customAttribute6 != null)
                    {
                        ...
                        {
                            MethodInfo method = instance.GetType().GetMethod(customAttribute6.GetMethodName, BindingFlags.Instance | BindingFlags.Public);
                            if (method != (MethodInfo)null)
                                method.Invoke(instance, new object[1]
                                {
                  (object) xmlWriter
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (customAttribute7 != null)
                            {
                                ...
                                if (method != (MethodInfo)null && method.Invoke(instance, (object[])null) is string[] strArray)
                                {
