...
public class BaseConverter
{
    ...
    public static BaseConverter BinToOct { get; } = new(2, NumberingSchemes.ZeroToZ, 8, NumberingSchemes.ZeroToZ);

    public static BaseConverter BinToDec { get; } = new(2, NumberingSchemes.ZeroToZ, 10, NumberingSchemes.ZeroToZ);

    public static BaseConverter BinToHex { get; } = new(2, NumberingSchemes.ZeroToZ, 16, NumberingSchemes.ZeroToZ);

    public static BaseConverter OctToBin { get; } = new(8, NumberingSchemes.ZeroToZ, 2, NumberingSchemes.ZeroToZ);

    public static BaseConverter OctToDec { get; } = new(8, NumberingSchemes.ZeroToZ, 10, NumberingSchemes.ZeroToZ);

    public static BaseConverter OctToHex { get; } = new(8, NumberingSchemes.ZeroToZ, 16, NumberingSchemes.ZeroToZ);

    public static BaseConverter DecToBin { get; } = new(10, NumberingSchemes.ZeroToZ, 2, NumberingSchemes.ZeroToZ);

    public static BaseConverter DecToOct { get; } = new(10, NumberingSchemes.ZeroToZ, 8, NumberingSchemes.ZeroToZ);

    public static BaseConverter DecToHex { get; } = new(10, NumberingSchemes.ZeroToZ, 16, NumberingSchemes.ZeroToZ);

    public static BaseConverter HexToBin { get; } = new(16, NumberingSchemes.ZeroToZ, 2, NumberingSchemes.ZeroToZ);

    public static BaseConverter HexToOct { get; } = new(16, NumberingSchemes.ZeroToZ, 8, NumberingSchemes.ZeroToZ);

    public static BaseConverter HexToDec { get; } = new(16, NumberingSchemes.ZeroToZ, 10, NumberingSchemes.ZeroToZ);
