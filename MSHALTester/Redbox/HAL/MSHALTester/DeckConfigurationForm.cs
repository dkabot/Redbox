...
public class DeckConfigurationForm : Form
{
    ...
    private void OnProperties(object sender, EventArgs e)
    {
        ...
        if (new DeckConfigurationDetailForm(true, Manager)
            {
    ...
    private void InitializeComponent()
    {
        ...
        m_sandGrid.Columns.AddRange(m_deckTextColumn, m_offsetTextColumn, m_slotWidthTextColumn, m_numSlotsTextColumn,
            m_isQlmTextColumn, m_fillerColumn);
