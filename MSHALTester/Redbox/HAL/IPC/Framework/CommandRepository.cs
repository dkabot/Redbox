...
public class CommandRepository
{
    ...
    private static readonly IDictionary<Type, CommandInstance>
        m_instanceCache = new Dictionary<Type, CommandInstance>();
    ...
    private static List<string> FindCommands(IEnumerable<Type> types)
    {
        ...
        foreach (var customAttribute in (CommandAttribute[])type.GetCustomAttributes(typeof(CommandAttribute), false))
