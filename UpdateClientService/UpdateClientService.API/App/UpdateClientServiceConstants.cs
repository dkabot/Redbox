...
namespace UpdateClientService.API.App
{
    public class UpdateClientServiceConstants
    {
        ...
        public static string DownloadDataFolder => Directory
            .CreateDirectory(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) +
                             "/Redbox/UpdateClient/DownloadData").FullName;
    }
}