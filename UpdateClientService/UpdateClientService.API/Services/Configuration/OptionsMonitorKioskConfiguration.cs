...
{
    public class OptionsMonitorKioskConfiguration : BaseKioskConfiguration, IOptionsMonitorKioskConfiguration,
        IKioskConfiguration
    {
        public OptionsMonitorKioskConfiguration(ILogger<OptionsMonitorKioskConfiguration> logger,
