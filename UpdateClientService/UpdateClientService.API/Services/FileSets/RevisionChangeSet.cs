...
namespace UpdateClientService.API.Services.FileSets
{
    public class RevisionChangeSet : RevisionChangeSetKey
    {
        ...
        public string StateText => Enum.GetName(typeof(ChangesetState), State);

        [JsonIgnore] public bool IsStaged => State != ChangesetState.Error && State >= ChangesetState.Staged;

        public static RevisionChangeSet Create(
            ClientFileSetRevisionChangeSet clientFileSetRevisionChangeSet)
        {
            var revisionChangeSet = new RevisionChangeSet();
            ...
            revisionChangeSet.Received = DateTime.Now;
