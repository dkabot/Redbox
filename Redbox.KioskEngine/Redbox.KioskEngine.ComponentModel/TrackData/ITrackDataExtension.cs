...
namespace Redbox.KioskEngine.ComponentModel.TrackData
{
    public static class ITrackDataExtension
    {
        ...
        public static bool CardSourceTypeIsEMVContactlessOrMobileOrMSDContactless(this ITrackData td)
        {
            if (td == null)
                return false;
            return td.CardSourceType == CardSourceType.EMVContactless || td.CardSourceType == CardSourceType.Mobile ||
                   td.CardSourceType == CardSourceType.MSDContactless;
        }
        ...
        {
            return td.HasErrors() && td.Errors.Any(e =>
                string.Equals(e.Code, "TAMPERED", StringComparison.CurrentCultureIgnoreCase));
        }
