...
{
    public partial class StartViewRentAndBuyTestUserControl : TextToSpeechUserControl
    {
        public StartViewRentAndBuyTestUserControl()
        {
            InitializeComponent();
            ApplyTheme();
            PostHealthActivity();
        ...
        private void ApplyTheme()
        {
            ...
            if (theme != null) theme.SetStyle(rent_and_buy_movies_button);
            ...
            if (theme != null) theme.SetStyle(help_button);
            if (theme != null) theme.SetStyle(sign_in_button);
            if (theme == null) return;
            theme.SetStyle(espanol_button);
        }
        ...
        private void RentAndBuyMoviesCommandBinding_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            RunCommandOnce(delegate
            {
                try
                {
                    ...
                    if (startViewModel != null) startViewModel.ProcessRentAndBuyMoviesButtonClick();
                    HandleWPFHit();
                }
                finally
                {
