...
{
    [ThemedControl(ThemeName = "Redbox Classic", ControlName = "KeyboardPerksSignupView")]
    public partial class KeyboardPerksSignupViewControl : KeyboardControl
    {
        public KeyboardPerksSignupViewControl()
        {
            KeyboardMode = KeyboardMode.PERKS_SIGN_UP;
            InitializeComponent();
