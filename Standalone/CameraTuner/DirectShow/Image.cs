...
namespace Redbox.DirectShow
{
    public static class Image
    {
        ...
        public static unsafe Bitmap Convert16bppTo8bpp(Bitmap bimap)
        {
            ...
            var bitmapdata1 = bimap.LockBits(new Rectangle(0, 0, width, height), ImageLockMode.ReadOnly,
                bimap.PixelFormat);
            var bitmapdata2 = bitmap.LockBits(new Rectangle(0, 0, width, height), ImageLockMode.ReadWrite,
                bitmap.PixelFormat);
