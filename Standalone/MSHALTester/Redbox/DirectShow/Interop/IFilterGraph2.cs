...
internal interface IFilterGraph2
{
    ...
    int ConnectDirect([In] IPin pinOut, [In] IPin pinIn,
        [MarshalAs(UnmanagedType.LPStruct)] [In] AMMediaType mediaType);
    ...
    [MethodImpl(MethodImplOptions.PreserveSig)]
    int RenderFile([MarshalAs(UnmanagedType.LPWStr)] [In] string file,
        [MarshalAs(UnmanagedType.LPWStr)] [In] string playList);

    [MethodImpl(MethodImplOptions.PreserveSig)]
    int AddSourceFilter([MarshalAs(UnmanagedType.LPWStr)] [In] string fileName,
        [MarshalAs(UnmanagedType.LPWStr)] [In] string filterName, out IBaseFilter filter);
