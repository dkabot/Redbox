...
internal interface IAMStreamConfig
{
    ...
    [MethodImpl(MethodImplOptions.PreserveSig)]
    int GetStreamCaps([In] int index, [MarshalAs(UnmanagedType.LPStruct)] out AMMediaType mediaType,
        [MarshalAs(UnmanagedType.LPStruct)] [In] VideoStreamConfigCaps streamConfigCaps);
}