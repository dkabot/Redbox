    ...
    public class DeckConfigurationDetailForm : Form
    {
        ...
        private void RefreshView()
        {
            ...
            foreach (XmlNode childNode in WorkingNode.ChildNodes)
            {
                ...
                m_quadrantDataGridView.Rows.Add(num++, attributeValue1, attributeValue2, attributeValue3,
                    attributeValue4);
            }
        ...
        private void OnComputeQuadrants(object sender, EventArgs e)
        {
            if (SlotWidth.HasValue)
            {
                ...
                var num1 = 0M;
                if ((slotWidth.GetValueOrDefault() <= num1 ? slotWidth.HasValue ? 1 : 0 : 0) == 0)
                {
                    m_errorProvider.SetError(m_slotWidthTextBox, string.Empty);
                    ...
                    computeQuadrantsForm1.NumberOfQuadrants =
                        (numberOfSlots.GetValueOrDefault() == num2 ? numberOfSlots.HasValue ? 1 : 0 : 0) != 0 ? 6 : 12;
                    numberOfSlots = NumberOfSlots;
                    var num3 = 90;
                    computeQuadrantsForm1.SlotsPerQuadrant =
                        (numberOfSlots.GetValueOrDefault() == num3 ? numberOfSlots.HasValue ? 1 : 0 : 0) != 0 ? 15 : 6;
