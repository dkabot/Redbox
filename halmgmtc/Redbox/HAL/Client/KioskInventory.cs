...
namespace Redbox.HAL.Client
{
    public sealed class KioskInventory : IDisposable
    {
        ...
        public IList<IInventoryLocation> DeckInventory => DeckInfo;

        public IList<IDumpbinItem> DumpbinItems => DumpbinInfo;
        ...
        private void Load()
        {
            ...
            using (var txtReader = new StringReader(inventoryState.CommandMessages[0]))
            {
                ...
                for (var i = 0; i < elementsByTagName1.Count; ++i)
                {
                    ...
                    DeckInfo.Add(new InventoryLocation(Convert.ToInt32(elementsByTagName1[i].Attributes["deck"].Value),
                ...
                DeckInfo.Sort(new InventoryLocationSorter());
                ...
                for (var i = 0; i < elementsByTagName2.Count; ++i)
                {
                    ...
                    DumpbinInfo.Add(new DumpbinItem(elementsByTagName2[i].Attributes["id"].Value, putTime));
                }
            }
        }
