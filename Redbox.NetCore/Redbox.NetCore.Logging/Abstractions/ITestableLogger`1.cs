...
namespace Redbox.NetCore.Logging.Abstractions
{
    public interface ITestableLogger<T>
    {
        ...
        void LogDebugWithSource(string message, [CallerMemberName] string memberName = "",
            [CallerFilePath] string callerLocation = "");

        void LogInfoWithSource(string message, [CallerMemberName] string memberName = "",
            [CallerFilePath] string callerLocation = "");
        ...
        void LogErrorWithSource(string message, [CallerMemberName] string memberName = "",
            [CallerFilePath] string callerLocation = "");

        void LogWarningWithSource(string message, [CallerMemberName] string memberName = "",
            [CallerFilePath] string callerLocation = "");

        void LogCriticalWithSource(string message, [CallerMemberName] string memberName = "",
            [CallerFilePath] string callerLocation = "");
